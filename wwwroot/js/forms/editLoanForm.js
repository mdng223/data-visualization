...
export default{
    ...
    methods: {
        cancel: function() {
            this.$emit('cancel-to-loan-page', true);
        },
        ...
        edit: function() {
            if (this.formData.email == this.currentEmail &&
                ...
                axios({
                  ...
                  .then( () => {
                    this.$emit('edit-to-loan-page', true);
                  })
            }
        },
        getRoleId: function(roleName) {
            if (roleName == 'Administrator'){
                ...
                return 2;
            } else if (this.formData.roleName == 'Loan') {
                return 3;
            }
            return 0;
        },
        ...
        uniqueEmail: function (email) {
            var length = this.loans.length;
            for (var i = 0; i < length; i++) {
                if (email == this.loans[i].email &&
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control form-control-sm" v-model="formData.loanName" />
    ...
    <div class="form-group"></div>
        ...
        <button type="button" class="btn btn-primary" v-on:click="edit">Edit Loan</button>
    </div>
    </form>
    `
  }